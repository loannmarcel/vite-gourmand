document.addEventListener("DOMContentLoaded", () => {
    const savedOrder =
        sessionStorage.getItem("viteGourmandConfirmedOrder");
    ...
    const menuElement =
        document.getElementById("confirmation-menu");

    const peopleElement =
        document.getElementById("confirmation-people");

    const dateElement =
        document.getElementById("confirmation-date");

    const timeElement =
        document.getElementById("confirmation-time");
